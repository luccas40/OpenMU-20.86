// <copyright file="RespawnAfterDeathPlugInS21.cs" company="MUnique">
...
/// </summary>
[PlugIn(nameof(RespawnAfterDeathPlugInS21), "The default implementation of the IRespawnAfterDeathPlugIn which is forwarding everything to the game client with specific data packets.")]
[Guid("922CD282-3429-46ED-9C90-005F02994A7E")]
[MinimumClient(21, 0, ClientLanguage.Korean)]
public class RespawnAfterDeathPlugInS21 : IRespawnAfterDeathPlugIn
{
    private readonly RemotePlayer _player;

    /// <summary>
    /// Initializes a new instance of the <see cref="RespawnAfterDeathPlugInS21"/> class.
    /// </summary>
    /// <param name="player">The player.</param>
    public RespawnAfterDeathPlugInS21(RemotePlayer player) => this._player = player;
    ...
    public async ValueTask RespawnAsync()
    {
        ...
        await this._player.Connection.SendRespawnAfterDeathS21Async(
                position.X,
                position.Y,
                mapNumber,
