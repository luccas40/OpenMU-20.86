// <copyright file="ShowSkillAnimationPlugInS21.cs" company="MUnique">
...
/// </summary>
[PlugIn(nameof(ShowSkillAnimationPlugInS21), "The S21 implementation of the IShowSkillAnimationPlugIn which is forwarding everything to the game client with specific data packets.")]
[Guid("B11BC6BD-A6DD-4C86-8388-8C7328E018DB")]
[MinimumClient(21, 0, ClientLanguage.Korean)]
public class ShowSkillAnimationPlugInS21 : IShowSkillAnimationPlugIn
{
    /// <summary>
    ...
    public ShowSkillAnimationPlugInS21(RemotePlayer player) => this._player = player;
    ...
    public async ValueTask ShowSkillAnimationAsync(IAttacker attacker, IAttackable? target, short skillNumber, bool effectApplied)
    {
        ...
        await this._player.Connection.SendSkillAnimationS21Async(playerId, skillId, targetId).ConfigureAwait(false);
    }
    ...
    public async ValueTask ShowComboAnimationAsync(IAttacker attacker, IAttackable? target)
    {
        ...
        await this._player.Connection.SendSkillAnimationS21Async(playerId, ComboSkillId, targetId).ConfigureAwait(false);
    }
    ...
    {
        var playerId = attacker.GetId(this._player);
        await this._player.Connection.SendSkillAnimationS21Async(playerId, NovaStartSkillId, 0).ConfigureAwait(false);
    }
}