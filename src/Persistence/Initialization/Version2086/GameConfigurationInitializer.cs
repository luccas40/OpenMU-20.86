...
public class GameConfigurationInitializer : GameConfigurationInitializerBase
{
    ...
    public GameConfigurationInitializer(IContext context, GameConfiguration gameConfiguration) : base(context, gameConfiguration)
    {
    }
    ...
    public override void Initialize()
    {
        ...
        new Version2086.Quests(this.Context, this.GameConfiguration).Initialize();
