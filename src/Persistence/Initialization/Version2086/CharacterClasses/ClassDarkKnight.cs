...
internal partial class CharacterClassInitialization
{
    ...
    private CharacterClass CreateBladeMaster(CharacterClass dragonKnight)
    {
        var result = this.CreateDarkKnight(CharacterClassNumber.BladeMaster, "Blade Master", true, dragonKnight, false);
    ...
    private CharacterClass CreateDragonKnight(CharacterClass ignitionKnight)
    {
        return this.CreateDarkKnight(CharacterClassNumber.DragonKnight, "Dragon Knight", true, ignitionKnight, false);
    }

    private CharacterClass CreateIgnitionKnight()
    {
        return this.CreateDarkKnight(CharacterClassNumber.IgnitionKnight, "Ignition Knight", true, null, false);
    }
}