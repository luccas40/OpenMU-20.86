...
internal partial class CharacterClassInitialization
{
    ...
    protected CharacterClass CreateRuneWizard(CharacterClassNumber number, string name, bool isMaster, CharacterClass? nextGenerationClass, bool canGetCreated)
    {
    ...
    private CharacterClass CreateGrandRuneMaster(CharacterClass nextGen)
    {
        var result = this.CreateRuneWizard(CharacterClassNumber.GrandRuneMaster, "Grand Rune Master", true, nextGen, false);
        result.StatAttributes.Add(this.CreateStatAttributeDefinition(Stats.MasterLevel, 0, false));
        return result;
    }

    private CharacterClass CreateRuneSpellMaster(CharacterClass nextGen)
    {
        return this.CreateRuneWizard(CharacterClassNumber.RuneSpellMaster, "Rune Spell Master", false, nextGen, false);
    }

    private CharacterClass CreateMajesticRuneWizard(CharacterClass nextGen)
    {
        return this.CreateRuneWizard(CharacterClassNumber.MajesticRuneWizard, "Majestic Rune Wizard", true, nextGen, false);
    }

    private CharacterClass CreateInfinityRuneWizard()
    {
        return this.CreateRuneWizard(CharacterClassNumber.InfinityRuneWizard, "Infinity Rune Wizard", true, null, false);
    }
}