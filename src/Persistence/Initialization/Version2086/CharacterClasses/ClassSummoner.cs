...
{
    private CharacterClass CreateEndlessSummoner()
    {
        var result = this.CreateSummoner(CharacterClassNumber.EndlessSummoner, "Endless Summoner", true, null, false);
        return result;
    }

    private CharacterClass CreateDimensionSummoner(CharacterClass endlessSummoner)
    {
        return this.CreateSummoner(CharacterClassNumber.DimensionSummoner, "Dimension Summoner", true, endlessSummoner, false);
    }
    ...
    private CharacterClass CreateDimensionMaster(CharacterClass dimensionSummoner)
    {
        var result = this.CreateSummoner(CharacterClassNumber.DimensionMaster, "Dimension Master", true, dimensionSummoner, false);
