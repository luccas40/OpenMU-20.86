...
{
    private CharacterClass CreateBloodyFighter()
    {
        return this.CreateRageFighter(CharacterClassNumber.BloodyFighter, "Bloody Fighter", true, null, false);
    }

    private CharacterClass CreateFistBlazer(CharacterClass bloodyFighter)
    {
        return this.CreateRageFighter(CharacterClassNumber.FistBlazer, "Fist Blazer", true, bloodyFighter, false);
    }

    private CharacterClass CreateFistMaster(CharacterClass fistBlazer)
    {
        var result = this.CreateRageFighter(CharacterClassNumber.FistMaster, "Fist Master", true, fistBlazer, false);
