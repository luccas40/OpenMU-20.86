...
internal partial class CharacterClassInitialization
{
    ...
    private CharacterClass CreateDuelMaster(CharacterClass magicKnight)
    {
        var result = this.CreateMagicGladiator(CharacterClassNumber.DuelMaster, "Duel Master", true, magicKnight, false);
        result.StatAttributes.Add(this.CreateStatAttributeDefinition(Stats.MasterLevel, 0, false));
        return result;
    }

    private CharacterClass CreateMagicKnight(CharacterClass dupleKnight)
    {
        var result = this.CreateMagicGladiator(CharacterClassNumber.MagicKnight, "Magic Knight", true, dupleKnight, false);
        return result;
    }

    private CharacterClass CreateDupleKnight()
    {
        var result = this.CreateMagicGladiator(CharacterClassNumber.DupleKnight, "Magic Knight", true, null, false);
        return result;
    }
