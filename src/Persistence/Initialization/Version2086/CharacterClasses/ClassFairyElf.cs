...
internal partial class CharacterClassInitialization
{
    ...
    private CharacterClass CreateHighElf(CharacterClass nobleElf)
    {
        var result = this.CreateFairyElf(CharacterClassNumber.HighElf, "High Elf", true, nobleElf, false);
        result.StatAttributes.Add(this.CreateStatAttributeDefinition(Stats.MasterLevel, 0, false));
        return result;
    }

    private CharacterClass CreateNobleElf(CharacterClass royalElf)
    {
        return this.CreateFairyElf(CharacterClassNumber.NobleElf, "NobleElf", true, royalElf, false);
    }

    private CharacterClass CreateRoyalElf()
    {
        return this.CreateFairyElf(CharacterClassNumber.RoyalElf, "Muse Elf", true, null, false);
    }
}