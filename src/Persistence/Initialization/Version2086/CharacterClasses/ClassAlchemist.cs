...
internal partial class CharacterClassInitialization
{
    ...
    protected CharacterClass CreateAlchemist(CharacterClassNumber number, string name, bool isMaster, CharacterClass? nextGenerationClass, bool canGetCreated)
    {
    ...
    private CharacterClass CreateAlchemicMaster(CharacterClass nextGenerationClass)
    {
        var result = this.CreateAlchemist(CharacterClassNumber.AlchemicMaster, "Alchemic Master", true, nextGenerationClass, false);
        result.StatAttributes.Add(this.CreateStatAttributeDefinition(Stats.MasterLevel, 0, false));
        return result;
    }

    private CharacterClass CreateAlchemicMagician(CharacterClass nextGenerationClass)
    {
        return this.CreateAlchemist(CharacterClassNumber.AlchemicMagician, "Alchemic Magician", false, nextGenerationClass, false);
    }

    private CharacterClass CreateAlchemicForce(CharacterClass nextGenerationClass)
    {
        return this.CreateAlchemist(CharacterClassNumber.AlchemicForce, "Alchemic Force", true, nextGenerationClass, false);
    }

    private CharacterClass CreateCreator()
    {
        return this.CreateAlchemist(CharacterClassNumber.Creator, "Creator", true, null, false);
    }
}