...
internal partial class CharacterClassInitialization
{
    ...
    protected CharacterClass CreateSlayer(CharacterClassNumber number, string name, bool isMaster, CharacterClass? nextGenerationClass, bool canGetCreated)
    {
    ...
    private CharacterClass CreateMasterSlayer(CharacterClass nextGenerationClass)
    {
        var result = this.CreateSlayer(CharacterClassNumber.MasterSlayer, "Master Slayer", true, nextGenerationClass, false);
        result.StatAttributes.Add(this.CreateStatAttributeDefinition(Stats.MasterLevel, 0, false));
        return result;
    }

    private CharacterClass CreateRoyalSlayer(CharacterClass nextGenerationClass)
    {
        return this.CreateSlayer(CharacterClassNumber.RoyalSlayer, "Royal Slayer", false, nextGenerationClass, false);
    }

    private CharacterClass CreateSlaughterer(CharacterClass nextGenerationClass)
    {
        return this.CreateSlayer(CharacterClassNumber.Slaughterer, "Slaughterer", true, nextGenerationClass, false);
    }

    private CharacterClass CreateRogueSlayer()
    {
        return this.CreateSlayer(CharacterClassNumber.RogueSlayer, "Rogue Slayer", true, null, false);
    }
}