...
internal partial class CharacterClassInitialization
{
    ...
    protected CharacterClass CreateIllusionKnight(CharacterClassNumber number, string name, bool isMaster, CharacterClass? nextGenerationClass, bool canGetCreated)
    {
    ...
    private CharacterClass CreateIllusionMaster(CharacterClass nextGenerationClass)
    {
        var result = this.CreateIllusionKnight(CharacterClassNumber.IllusionMaster, "Illusion Master", true, nextGenerationClass, false);
        result.StatAttributes.Add(this.CreateStatAttributeDefinition(Stats.MasterLevel, 0, false));
        return result;
    }

    private CharacterClass CreateMirageKnight(CharacterClass nextGenerationClass)
    {
        return this.CreateIllusionKnight(CharacterClassNumber.MirageKnight, "Mirage Knight", false, nextGenerationClass, false);
    }

    private CharacterClass CreateMysticKnight(CharacterClass nextGenerationClass)
    {
        return this.CreateIllusionKnight(CharacterClassNumber.MysticKnight, "Mystic Knight", true, nextGenerationClass, false);
    }

    private CharacterClass CreatePhantomPainKnight()
    {
        return this.CreateIllusionKnight(CharacterClassNumber.PhantomPainKnight, "Phantom Pain Knight", true, null, false);
    }
}