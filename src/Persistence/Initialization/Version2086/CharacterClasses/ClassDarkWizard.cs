...
internal partial class CharacterClassInitialization
{
    ...
    private CharacterClass CreateGrandMaster(CharacterClass soulWizard)
    {
        var result = this.CreateDarkWizard(CharacterClassNumber.GrandMaster, "Grand Master", true, soulWizard, false);
        result.StatAttributes.Add(this.CreateStatAttributeDefinition(Stats.MasterLevel, 0, false));
        return result;
    }

    private CharacterClass CreateSoulWizard(CharacterClass darknessWizard)
    {
        return this.CreateDarkWizard(CharacterClassNumber.SoulWizard, "Soul Wizard", true, darknessWizard, false);
    }

    private CharacterClass CreateDarknessWizard()
    {
        return this.CreateDarkWizard(CharacterClassNumber.DarknessWizard, "DarknessWizard", true, null, false);
    }
