...
internal partial class CharacterClassInitialization
{
    ...
    protected CharacterClass CreateWhiteWizard(CharacterClassNumber number, string name, bool isMaster, CharacterClass? nextGenerationClass, bool canGetCreated)
    {
    ...
    private CharacterClass CreateShineWizard(CharacterClass nextGenerationClass)
    {
        var result = this.CreateWhiteWizard(CharacterClassNumber.ShineWizard, "Shine Wizard", true, nextGenerationClass, false);
        result.StatAttributes.Add(this.CreateStatAttributeDefinition(Stats.MasterLevel, 0, false));
        return result;
    }

    private CharacterClass CreateLightMaster(CharacterClass nextGenerationClass)
    {
        return this.CreateWhiteWizard(CharacterClassNumber.LightMaster, "Light Master", false, nextGenerationClass, false);
    }

    private CharacterClass CreateLuminousWizard(CharacterClass nextGenerationClass)
    {
        return this.CreateWhiteWizard(CharacterClassNumber.LuminousWizard, "Luminous Wizard", true, nextGenerationClass, false);
    }

    private CharacterClass CreateGloryWizard()
    {
        return this.CreateWhiteWizard(CharacterClassNumber.GloryWizard, "Glory Wizard", true, null, false);
    }
}