// <copyright file="Labyrinth.cs" company="MUnique">
...
/// </summary>
internal class Labyrinth : BaseMapInitializer
{
    /// <summary>
    /// The Number of the Map.
    /// </summary>
    internal const byte Number = 115;

    /// <summary>
    /// The Name of the Map.
    /// </summary>
    internal const string Name = "Labyrinth";
    ...
    public Labyrinth(IContext context, GameConfiguration gameConfiguration)
