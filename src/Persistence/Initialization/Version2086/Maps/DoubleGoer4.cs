...
/// </summary>
internal class DoubleGoer4 : BaseMapInitializer
{
    /// <summary>
    ...
    /// The Name of the Map.
    /// </summary>
    internal const string Name = "DoubleGoer 4";

    /// <summary>
    /// Initializes a new instance of the <see cref="DoubleGoer4"/> class.
    /// </summary>
    /// <param name="context">The context.</param>
    /// <param name="gameConfiguration">The game configuration.</param>
    public DoubleGoer4(IContext context, GameConfiguration gameConfiguration)
