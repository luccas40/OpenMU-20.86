...
/// </summary>
internal class DoubleGoer5 : BaseMapInitializer
{
    /// <summary>
    ...
    /// The Name of the Map.
    /// </summary>
    internal const string Name = "DoubleGoer 5";

    /// <summary>
    /// Initializes a new instance of the <see cref="DoubleGoer5"/> class.
    /// </summary>
    /// <param name="context">The context.</param>
    /// <param name="gameConfiguration">The game configuration.</param>
    public DoubleGoer5(IContext context, GameConfiguration gameConfiguration)
