...
/// </summary>
internal class DoubleGoer2 : BaseMapInitializer
{
    /// <summary>
    ...
    /// The Name of the Map.
    /// </summary>
    internal const string Name = "DoubleGoer 2";

    /// <summary>
    /// Initializes a new instance of the <see cref="DoubleGoer2"/> class.
    /// </summary>
    /// <param name="context">The context.</param>
    /// <param name="gameConfiguration">The game configuration.</param>
    public DoubleGoer2(IContext context, GameConfiguration gameConfiguration)
