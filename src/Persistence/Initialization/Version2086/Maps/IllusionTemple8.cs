// <copyright file="IllusionTemple8.cs" company="MUnique">
...
/// <summary>
/// Initialization for the Illusion Temple 8.
/// </summary>
internal class IllusionTemple8 : BaseMapInitializer
{
    /// <summary>
    /// The Number of the Map.
    /// </summary>
    internal const byte Number = 99;

    /// <summary>
    /// The Name of the Map.
    /// </summary>
    internal const string Name = "Illusion Temple 8";

    /// <summary>
    /// Initializes a new instance of the <see cref="IllusionTemple8"/> class.
    /// </summary>
    /// <param name="context">The context.</param>
    /// <param name="gameConfiguration">The game configuration.</param>
    public IllusionTemple8(IContext context, GameConfiguration gameConfiguration)
