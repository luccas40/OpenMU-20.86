...
/// </summary>
internal class DoubleGoer7 : BaseMapInitializer
{
    /// <summary>
    /// The Number of the Map.
    /// </summary>
    internal const byte Number = 88;

    /// <summary>
    /// The Name of the Map.
    /// </summary>
    internal const string Name = "DoubleGoer 7";

    /// <summary>
    /// Initializes a new instance of the <see cref="DoubleGoer7"/> class.
    /// </summary>
    /// <param name="context">The context.</param>
    /// <param name="gameConfiguration">The game configuration.</param>
    public DoubleGoer7(IContext context, GameConfiguration gameConfiguration)
