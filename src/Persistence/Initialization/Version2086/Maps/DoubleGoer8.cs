...
/// </summary>
internal class DoubleGoer8 : BaseMapInitializer
{
    /// <summary>
    /// The Number of the Map.
    /// </summary>
    internal const byte Number = 89;

    /// <summary>
    /// The Name of the Map.
    /// </summary>
    internal const string Name = "DoubleGoer 8";

    /// <summary>
    /// Initializes a new instance of the <see cref="DoubleGoer8"/> class.
    /// </summary>
    /// <param name="context">The context.</param>
    /// <param name="gameConfiguration">The game configuration.</param>
    public DoubleGoer8(IContext context, GameConfiguration gameConfiguration)
