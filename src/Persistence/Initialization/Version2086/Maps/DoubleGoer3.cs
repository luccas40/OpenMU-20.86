...
/// </summary>
internal class DoubleGoer3 : BaseMapInitializer
{
    /// <summary>
    ...
    /// The Name of the Map.
    /// </summary>
    internal const string Name = "DoubleGoer 3";

    /// <summary>
    /// Initializes a new instance of the <see cref="DoubleGoer3"/> class.
    /// </summary>
    /// <param name="context">The context.</param>
    /// <param name="gameConfiguration">The game configuration.</param>
    public DoubleGoer3(IContext context, GameConfiguration gameConfiguration)
