...
/// </summary>
internal class DoubleGoer9 : BaseMapInitializer
{
    /// <summary>
    ...
    /// The Name of the Map.
    /// </summary>
    internal const string Name = "DoubleGoer 9";

    /// <summary>
    /// Initializes a new instance of the <see cref="DoubleGoer9"/> class.
    /// </summary>
    /// <param name="context">The context.</param>
    /// <param name="gameConfiguration">The game configuration.</param>
    public DoubleGoer9(IContext context, GameConfiguration gameConfiguration)
