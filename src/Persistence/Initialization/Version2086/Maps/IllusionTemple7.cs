// <copyright file="IllusionTemple7.cs" company="MUnique">
...
/// <summary>
/// Initialization for the Illusion Temple 7.
/// </summary>
internal class IllusionTemple7 : BaseMapInitializer
{
    /// <summary>
    /// The Number of the Map.
    /// </summary>
    internal const byte Number = 98;

    /// <summary>
    /// The Name of the Map.
    /// </summary>
    internal const string Name = "Illusion Temple 7";

    /// <summary>
    /// Initializes a new instance of the <see cref="IllusionTemple7"/> class.
    /// </summary>
    /// <param name="context">The context.</param>
    /// <param name="gameConfiguration">The game configuration.</param>
    public IllusionTemple7(IContext context, GameConfiguration gameConfiguration)
