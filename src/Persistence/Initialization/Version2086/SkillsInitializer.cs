...
internal class SkillsInitializer : SkillsInitializerBase
{
    ...
    {
        this.CreateSkill(SkillNumber.Poison, "Poison", ClassConsts.ALL_MAGICIANS, DamageType.Wizardry, 12, 6, manaConsumption: 42, energyRequirement: 140, elementalModifier: ElementalType.Poison);
        this.CreateSkill(SkillNumber.Meteorite, "Meteorite", [.. ClassConsts.ALL_MAGICIANS, ..ClassConsts.ALL_SUMMONERS], DamageType.Wizardry, 21, 6, manaConsumption: 12, energyRequirement: 104, elementalModifier: ElementalType.Earth);
        this.CreateSkill(SkillNumber.Lightning, "Lightning", ClassConsts.ALL_MAGICIANS, DamageType.Wizardry, 17, 6, manaConsumption: 15, energyRequirement: 72, elementalModifier: ElementalType.Lightning);
        this.CreateSkill(SkillNumber.FireBall, "Fire Ball", [.. ClassConsts.ALL_MAGICIANS, .. ClassConsts.ALL_SUMMONERS], DamageType.Wizardry, 8, 6, manaConsumption: 3, energyRequirement: 40, elementalModifier: ElementalType.Fire);
        this.CreateSkill(SkillNumber.Flame, "Flame", ClassConsts.ALL_MAGICIANS, DamageType.Wizardry, 25, 6, manaConsumption: 50, energyRequirement: 160, elementalModifier: ElementalType.Fire, skillType: SkillType.AreaSkillAutomaticHits);
        ...
        this.CreateSkill(SkillNumber.Teleport, "Teleport", ClassConsts.WIZARD_SECOND_PLUS, DamageType.Wizardry, distance: 6, manaConsumption: 30, energyRequirement: 88, skillType: SkillType.Other);
        this.CreateSkill(SkillNumber.Ice, "Ice", [.. ClassConsts.ALL_MAGICIANS, .. ClassConsts.ALL_SUMMONERS], DamageType.Wizardry, 10, 6, manaConsumption: 38, energyRequirement: 120, elementalModifier: ElementalType.Ice);
        this.CreateSkill(SkillNumber.Twister, "Twister", ClassConsts.ALL_MAGICIANS, DamageType.Wizardry, 35, 6, manaConsumption: 60, energyRequirement: 180, elementalModifier: ElementalType.Wind, skillType: SkillType.AreaSkillAutomaticHits);
        ...
        this.CreateSkill(SkillNumber.EvilSpirit, "Evil Spirit", ClassConsts.ALL_MAGICIANS, DamageType.Wizardry, 45, 7, manaConsumption: 90, energyRequirement: 220, skillType: SkillType.AreaSkillAutomaticHits);
        ...
        this.CreateSkill(SkillNumber.Hellfire, "Hellfire", ClassConsts.ALL_MAGICIANS, DamageType.Wizardry, 120, 4, manaConsumption: 160, energyRequirement: 260, elementalModifier: ElementalType.Fire, skillType: SkillType.AreaSkillAutomaticHits);
        this.CreateSkill(SkillNumber.PowerWave, "Power Wave", [.. ClassConsts.ALL_MAGICIANS, .. ClassConsts.ALL_SUMMONERS], DamageType.Wizardry, 14, 6, manaConsumption: 5, energyRequirement: 56);
        this.CreateSkill(SkillNumber.AquaBeam, "Aqua Beam", ClassConsts.ALL_MAGICIANS, DamageType.Wizardry, 80, 6, manaConsumption: 140, energyRequirement: 345, elementalModifier: ElementalType.Water, skillType: SkillType.AreaSkillAutomaticHits);
        this.AddAreaSkillSettings(SkillNumber.AquaBeam, true, 1.5f, 1.5f, 8f);
        this.CreateSkill(SkillNumber.Cometfall, "Cometfall", ClassConsts.ALL_MAGICIANS, DamageType.Wizardry, 70, 3, manaConsumption: 150, energyRequirement: 436, skillType: SkillType.AreaSkillAutomaticHits);
        ...
        this.CreateSkill(SkillNumber.Inferno, "Inferno", ClassConsts.ALL_MAGICIANS, DamageType.Wizardry, 100, 4, manaConsumption: 200, energyRequirement: 578, elementalModifier: ElementalType.Fire, skillType: SkillType.AreaSkillAutomaticHits);
        this.CreateSkill(SkillNumber.TeleportAlly, "Teleport Ally", ClassConsts.WIZARD_SECOND_PLUS, distance: 6, abilityConsumption: 25, manaConsumption: 90, energyRequirement: 644, skillType: SkillType.Other);
        this.CreateSkill(SkillNumber.SoulBarrier, "Soul Barrier", ClassConsts.WIZARD_SECOND_PLUS, distance: 6, abilityConsumption: 22, manaConsumption: 70, energyRequirement: 408, skillType: SkillType.Buff, implicitTargetRange: 0, targetRestriction: SkillTargetRestriction.Party);
        this.CreateSkill(SkillNumber.EnergyBall, "Energy Ball", ClassConsts.ALL_MAGICIANS, DamageType.Wizardry, 3, 6, manaConsumption: 1);
        this.CreateSkill(SkillNumber.Defense, "Defense",[.. ClassConsts.ALL_KNIGHTS, .. ClassConsts.ALL_MGS, ..ClassConsts.ALL_DLS], manaConsumption: 30, skillType: SkillType.Buff, implicitTargetRange: 0, targetRestriction: SkillTargetRestriction.Self);
        this.CreateSkill(SkillNumber.FallingSlash, "Falling Slash", [.. ClassConsts.ALL_KNIGHTS, .. ClassConsts.ALL_MGS, ..ClassConsts.ALL_DLS, ..ClassConsts.ALL_FIGHTERS], DamageType.Physical, distance: 3, manaConsumption: 9, movesToTarget: true, movesTarget: true);
        this.CreateSkill(SkillNumber.Lunge, "Lunge",[.. ClassConsts.ALL_KNIGHTS, .. ClassConsts.ALL_MGS, ..ClassConsts.ALL_DLS], DamageType.Physical, distance: 2, manaConsumption: 9, movesToTarget: true, movesTarget: true);
        this.CreateSkill(SkillNumber.Uppercut, "Uppercut",[.. ClassConsts.ALL_KNIGHTS, .. ClassConsts.ALL_MGS, ..ClassConsts.ALL_DLS], DamageType.Physical, distance: 2, manaConsumption: 8, movesToTarget: true, movesTarget: true);
        this.CreateSkill(SkillNumber.Cyclone, "Cyclone",[.. ClassConsts.ALL_KNIGHTS, .. ClassConsts.ALL_MGS, ..ClassConsts.ALL_DLS], DamageType.Physical, distance: 2, manaConsumption: 9, movesToTarget: true, movesTarget: true);
        this.CreateSkill(SkillNumber.Slash, "Slash",[.. ClassConsts.ALL_KNIGHTS, .. ClassConsts.ALL_MGS, ..ClassConsts.ALL_DLS], DamageType.Physical, distance: 2, manaConsumption: 10, movesToTarget: true, movesTarget: true);
        this.CreateSkill(SkillNumber.TripleShot, "Triple Shot", ClassConsts.ALL_ELFS, DamageType.Physical, distance: 6, manaConsumption: 5, skillType: SkillType.AreaSkillAutomaticHits);
        ...
        this.CreateSkill(SkillNumber.Heal, "Heal", ClassConsts.ALL_ELFS, distance: 6, manaConsumption: 20, energyRequirement: 52, skillType: SkillType.Regeneration, targetRestriction: SkillTargetRestriction.Player);
        this.CreateSkill(SkillNumber.GreaterDefense, "Greater Defense", ClassConsts.ALL_ELFS, distance: 6, manaConsumption: 30, energyRequirement: 72, skillType: SkillType.Buff, targetRestriction: SkillTargetRestriction.Player);
        this.CreateSkill(SkillNumber.GreaterDamage, "Greater Damage", ClassConsts.ALL_ELFS, distance: 6, manaConsumption: 40, energyRequirement: 92, skillType: SkillType.Buff, targetRestriction: SkillTargetRestriction.Player);
        this.CreateSkill(SkillNumber.SummonGoblin, "Summon Goblin", ClassConsts.ALL_ELFS, manaConsumption: 40, energyRequirement: 90, skillType: SkillType.SummonMonster);
        this.CreateSkill(SkillNumber.SummonStoneGolem, "Summon Stone Golem", ClassConsts.ALL_ELFS, manaConsumption: 70, energyRequirement: 170, skillType: SkillType.SummonMonster);
        this.CreateSkill(SkillNumber.SummonAssassin, "Summon Assassin", ClassConsts.ALL_ELFS, manaConsumption: 110, energyRequirement: 190, skillType: SkillType.SummonMonster);
        this.CreateSkill(SkillNumber.SummonEliteYeti, "Summon Elite Yeti", ClassConsts.ALL_ELFS, manaConsumption: 160, energyRequirement: 230, skillType: SkillType.SummonMonster);
        this.CreateSkill(SkillNumber.SummonDarkKnight, "Summon Dark Knight", ClassConsts.ALL_ELFS, manaConsumption: 200, energyRequirement: 250, skillType: SkillType.SummonMonster);
        this.CreateSkill(SkillNumber.SummonBali, "Summon Bali", ClassConsts.ALL_ELFS, manaConsumption: 250, energyRequirement: 260, skillType: SkillType.SummonMonster);
        this.CreateSkill(SkillNumber.SummonSoldier, "Summon Soldier", ClassConsts.ALL_ELFS, manaConsumption: 350, energyRequirement: 280, skillType: SkillType.SummonMonster);
        this.CreateSkill(SkillNumber.Decay, "Decay", ClassConsts.WIZARD_SECOND_PLUS, DamageType.Wizardry, 95, 6, 7, 110, energyRequirement: 953, elementalModifier: ElementalType.Poison, skillType: SkillType.AreaSkillAutomaticHits);
        this.CreateSkill(SkillNumber.IceStorm, "Ice Storm", ClassConsts.WIZARD_SECOND_PLUS, DamageType.Wizardry, 80, 6, 5, 100, energyRequirement: 849, elementalModifier: ElementalType.Ice, skillType: SkillType.AreaSkillAutomaticHits);
        ...
        this.CreateSkill(SkillNumber.Nova, "Nova", ClassConsts.WIZARD_SECOND_PLUS, DamageType.Wizardry, distance: 6, manaConsumption: 180 / 12 /* mana per stage */, levelRequirement: 100, energyRequirement: 1052, elementalModifier: ElementalType.Fire);
        this.CreateSkill(SkillNumber.NovaStart, "Nova (Start)", ClassConsts.WIZARD_SECOND_PLUS, DamageType.None, abilityConsumption: 45, levelRequirement: 100, energyRequirement: 1052, skillType: SkillType.Other);
        this.CreateSkill(SkillNumber.TwistingSlash, "Twisting Slash", [..ClassConsts.ALL_KNIGHTS, ..ClassConsts.ALL_MGS], DamageType.Physical, distance: 2, abilityConsumption: 10, manaConsumption: 10, elementalModifier: ElementalType.Wind, skillType: SkillType.AreaSkillAutomaticHits);
        this.CreateSkill(SkillNumber.RagefulBlow, "Rageful Blow", ClassConsts.KNIGHT_SECOND_PLUS, DamageType.Physical, 60, 3, 20, 25, 170, elementalModifier: ElementalType.Earth, skillType: SkillType.AreaSkillAutomaticHits);
        this.CreateSkill(SkillNumber.DeathStab, "Death Stab", ClassConsts.KNIGHT_SECOND_PLUS, DamageType.Physical, 70, 2, 12, 15, 160, elementalModifier: ElementalType.Wind, skillType: SkillType.DirectHit, skillTarget: SkillTarget.ExplicitWithImplicitInRange, implicitTargetRange: 1);
        this.CreateSkill(SkillNumber.CrescentMoonSlash, "Crescent Moon Slash", ClassConsts.ALL_KNIGHTS, DamageType.Physical, 90, 4, 15, 22, movesToTarget: true, movesTarget: true);
        this.CreateSkill(SkillNumber.Lance, "Lance", [..ClassConsts.WIZARD_SECOND_PLUS, ..ClassConsts.ALL_SUMMONERS], DamageType.Wizardry, 90, 6, 10, 150);
        this.CreateSkill(SkillNumber.Starfall, "Starfall", ClassConsts.ALL_ELFS, DamageType.Physical, 120, 8, 15, 20);
        this.CreateSkill(SkillNumber.Impale, "Impale", [..ClassConsts.ALL_KNIGHTS, ..ClassConsts.ALL_MGS], DamageType.Physical, 15, 3, manaConsumption: 8, levelRequirement: 28);
        this.CreateSkill(SkillNumber.SwellLife, "Swell Life", ClassConsts.ALL_KNIGHTS, abilityConsumption: 24, manaConsumption: 22, levelRequirement: 120, skillType: SkillType.Buff, skillTarget: SkillTarget.ImplicitParty);
        this.CreateSkill(SkillNumber.FireBreath, "Fire Breath", ClassConsts.ALL_KNIGHTS, DamageType.Physical, 30, 3, manaConsumption: 9, levelRequirement: 110);
        ...
        this.CreateSkill(SkillNumber.IceArrow, "Ice Arrow", ClassConsts.ELF_SECOND_PLUS, DamageType.Physical, 105, 8, 12, 10, elementalModifier: ElementalType.Ice);
        this.CreateSkill(SkillNumber.Penetration, "Penetration", ClassConsts.ALL_ELFS, DamageType.Physical, 70, 6, 9, 7, 130, elementalModifier: ElementalType.Wind, skillType: SkillType.AreaSkillAutomaticHits);
        ...
        this.CreateSkill(SkillNumber.FireSlash, "Fire Slash", ClassConsts.ALL_MGS, DamageType.Physical, 80, 2, 20, 15, elementalModifier: ElementalType.Fire, skillType: SkillType.AreaSkillAutomaticHits);
        this.AddAreaSkillSettings(SkillNumber.FireSlash, true, 1.5f, 2, 2);
        this.CreateSkill(SkillNumber.PowerSlash, "Power Slash", ClassConsts.ALL_MGS, DamageType.Physical, distance: 5, manaConsumption: 15, skillType: SkillType.AreaSkillAutomaticHits);
        this.AddAreaSkillSettings(SkillNumber.PowerSlash, true, 1.0f, 6.0f, 6.0f);
        this.CreateSkill(SkillNumber.SpiralSlash, "Spiral Slash", ClassConsts.ALL_MGS, DamageType.Physical, 75, 5, 15, 20);
        this.CreateSkill(SkillNumber.Force, "Force", ClassConsts.ALL_DLS, DamageType.Physical, 10, 4, manaConsumption: 10);
        this.CreateSkill(SkillNumber.FireBurst, "Fire Burst", ClassConsts.ALL_DLS, DamageType.Physical, 100, 6, manaConsumption: 25, energyRequirement: 79, skillTarget: SkillTarget.ExplicitWithImplicitInRange, implicitTargetRange: 1);
        this.CreateSkill(SkillNumber.Earthshake, "Earthshake", ClassConsts.ALL_DLS, DamageType.Physical, 150, 10, 50, elementalModifier: ElementalType.Lightning, skillType: SkillType.AreaSkillAutomaticHits);
        this.CreateSkill(SkillNumber.Summon, "Summon", ClassConsts.ALL_DLS, abilityConsumption: 30, manaConsumption: 70, energyRequirement: 153, leadershipRequirement: 400, skillType: SkillType.Other);
        this.CreateSkill(SkillNumber.IncreaseCriticalDamage, "Increase Critical Damage", ClassConsts.ALL_DLS, abilityConsumption: 50, manaConsumption: 50, energyRequirement: 102, leadershipRequirement: 300, skillType: SkillType.Buff, skillTarget: SkillTarget.ImplicitParty);
        this.CreateSkill(SkillNumber.ElectricSpike, "Electric Spike", ClassConsts.ALL_DLS, DamageType.Physical, 250, 10, 100, energyRequirement: 126, leadershipRequirement: 340, skillType: SkillType.AreaSkillAutomaticHits);
        ...
        this.CreateSkill(SkillNumber.ForceWave, "Force Wave", ClassConsts.ALL_DLS, DamageType.Physical, 50, 4, manaConsumption: 10, skillTarget: SkillTarget.ExplicitWithImplicitInRange);
        this.AddAreaSkillSettings(SkillNumber.ForceWave, true, 1f, 1f, 4f);
        this.CreateSkill(SkillNumber.Stun, "Stun", ClassConsts.ALL, distance: 2, abilityConsumption: 50, manaConsumption: 70, skillType: SkillType.AreaSkillAutomaticHits, cooldownMinutes: 4);
        this.AddAreaSkillSettings(SkillNumber.Stun, true, 1.5f, 1.5f, 3f);
        this.CreateSkill(SkillNumber.CancelStun, "Cancel Stun", ClassConsts.ALL, abilityConsumption: 30, manaConsumption: 25, skillType: SkillType.Other, cooldownMinutes: 2);
        this.CreateSkill(SkillNumber.SwellMana, "Swell Mana", ClassConsts.ALL, abilityConsumption: 30, manaConsumption: 35, cooldownMinutes: 4);
        this.CreateSkill(SkillNumber.Invisibility, "Invisibility", ClassConsts.ALL, abilityConsumption: 60, manaConsumption: 80, cooldownMinutes: 5);
        this.CreateSkill(SkillNumber.CancelInvisibility, "Cancel Invisibility", ClassConsts.ALL, abilityConsumption: 30, manaConsumption: 40, cooldownMinutes: 2);
        this.CreateSkill(SkillNumber.AbolishMagic, "Abolish Magic", ClassConsts.ALL_DLS, abilityConsumption: 70, manaConsumption: 90, cooldownMinutes: 8);
        this.CreateSkill(SkillNumber.ManaRays, "Mana Rays", ClassConsts.ALL_MGS, DamageType.Wizardry, 85, 6, 7, 130);
        this.CreateSkill(SkillNumber.FireBlast, "Fire Blast", ClassConsts.ALL_DLS, DamageType.Physical, 150, 6, 10, 30);
        this.CreateSkill(SkillNumber.PlasmaStorm, "Plasma Storm", ClassConsts.ALL_SECOND_PLUS, DamageType.Fenrir, damage: 60, distance: 6, abilityConsumption: 20, manaConsumption: 50, levelRequirement: 110, skillType: SkillType.AreaSkillAutomaticHits);
        this.CreateSkill(SkillNumber.InfinityArrow, "Infinity Arrow", ClassConsts.ELF_SECOND_PLUS, distance: 6, abilityConsumption: 10, manaConsumption: 50, levelRequirement: 220, skillType: SkillType.Buff, targetRestriction: SkillTargetRestriction.Self);
        this.CreateSkill(SkillNumber.FireScream, "Fire Scream", ClassConsts.ALL_DLS, DamageType.Physical, 130, 6, 10, 45, energyRequirement: 70, leadershipRequirement: 150, skillType: SkillType.AreaSkillAutomaticHits);
        this.AddAreaSkillSettings(SkillNumber.FireScream, true, 2f, 3f, 6f); // TODO: Add fireScream's explosion (Explosion79) damage effect
        this.CreateSkill(SkillNumber.Explosion79, "Explosion", ClassConsts.ALL_DLS, DamageType.Physical, distance: 2);
        ...
        this.CreateSkill(SkillNumber.SpellofProtection, "Spell of Protection", ClassConsts.ALL, manaConsumption: 30, elementalModifier: ElementalType.Ice, cooldownMinutes: 5);
        this.CreateSkill(SkillNumber.SpellofRestriction, "Spell of Restriction", ClassConsts.ALL, distance: 3, manaConsumption: 30, elementalModifier: ElementalType.Ice, cooldownMinutes: 5);
        this.CreateSkill(SkillNumber.SpellofPursuit, "Spell of Pursuit", ClassConsts.ALL, manaConsumption: 30, elementalModifier: ElementalType.Ice, cooldownMinutes: 10);
        this.CreateSkill(SkillNumber.ShieldBurn, "Shield-Burn", ClassConsts.ALL, distance: 3, manaConsumption: 30, elementalModifier: ElementalType.Ice, cooldownMinutes: 5);
        this.CreateSkill(SkillNumber.DrainLife, "Drain Life", ClassConsts.ALL_SUMMONERS, DamageType.Wizardry, 35, 6, manaConsumption: 50, energyRequirement: 150, skillType: SkillType.AreaSkillExplicitTarget);
        this.CreateSkill(SkillNumber.ChainLightning, "Chain Lightning", ClassConsts.ALL_SUMMONERS, DamageType.Wizardry, 70, 6, manaConsumption: 85, energyRequirement: 245, skillType: SkillType.AreaSkillExplicitTarget, skillTarget: SkillTarget.Explicit);
        this.CreateSkill(SkillNumber.DamageReflection, "Damage Reflection", ClassConsts.ALL_SUMMONERS, distance: 5, abilityConsumption: 10, manaConsumption: 40, energyRequirement: 375);
        this.CreateSkill(SkillNumber.Berserker, "Berserker", ClassConsts.ALL_SUMMONERS, distance: 5, abilityConsumption: 50, manaConsumption: 100, energyRequirement: 620, skillType: SkillType.Buff, targetRestriction: SkillTargetRestriction.Self);
        this.CreateSkill(SkillNumber.Sleep, "Sleep", ClassConsts.ALL_SUMMONERS, distance: 6, abilityConsumption: 3, manaConsumption: 20, energyRequirement: 180);
        this.CreateSkill(SkillNumber.Weakness, "Weakness", ClassConsts.ALL_SUMMONERS, distance: 6, abilityConsumption: 15, manaConsumption: 50, energyRequirement: 663);
        this.CreateSkill(SkillNumber.Innovation, "Innovation", ClassConsts.ALL_SUMMONERS, distance: 6, abilityConsumption: 15, manaConsumption: 70, energyRequirement: 912);
        this.CreateSkill(SkillNumber.Explosion223, "Explosion", ClassConsts.ALL_SUMMONERS, DamageType.Curse, 40, 6, 5, 90, energyRequirement: 100, elementalModifier: ElementalType.Fire); // Book of Samut's skill
        this.CreateSkill(SkillNumber.Requiem, "Requiem", ClassConsts.ALL_SUMMONERS, DamageType.Curse, 65, 6, 10, 110, energyRequirement: 99, elementalModifier: ElementalType.Wind); // Book of Neil's skill
        this.CreateSkill(SkillNumber.Pollution, "Pollution", ClassConsts.ALL_SUMMONERS, DamageType.Curse, 80, 6, 15, 120, energyRequirement: 115, elementalModifier: ElementalType.Lightning); // Book of Lagle's skill
        this.CreateSkill(SkillNumber.LightningShock, "Lightning Shock", ClassConsts.ALL_SUMMONERS, DamageType.Wizardry, 95, 6, 7, 115, energyRequirement: 823, elementalModifier: ElementalType.Lightning);
        this.CreateSkill(SkillNumber.StrikeofDestruction, "Strike of Destruction", ClassConsts.KNIGHT_SECOND_PLUS, DamageType.Physical, 110, 5, 24, 30, 100, elementalModifier: ElementalType.Ice, skillType: SkillType.AreaSkillAutomaticHits);
        this.CreateSkill(SkillNumber.ExpansionofWizardry, "Expansion of Wizardry", ClassConsts.WIZARD_SECOND_PLUS, distance: 6, abilityConsumption: 50, manaConsumption: 200, levelRequirement: 220, energyRequirement: 118, skillType: SkillType.Buff, targetRestriction: SkillTargetRestriction.Player, skillTarget: SkillTarget.ImplicitPlayer);
        this.CreateSkill(SkillNumber.Recovery, "Recovery", ClassConsts.ELF_SECOND_PLUS, distance: 6, abilityConsumption: 10, manaConsumption: 40, levelRequirement: 100, energyRequirement: 37, skillType: SkillType.Regeneration, targetRestriction: SkillTargetRestriction.Player);
        this.CreateSkill(SkillNumber.MultiShot, "Multi-Shot", ClassConsts.ELF_SECOND_PLUS, DamageType.Physical, 40, 6, 7, 10, 100, skillType: SkillType.AreaSkillAutomaticHits);
        this.AddAreaSkillSettings(SkillNumber.MultiShot, true, 1f, 6f, 7f);
        this.CreateSkill(SkillNumber.FlameStrike, "Flame Strike", ClassConsts.ALL_MGS, DamageType.Physical, 140, 3, 25, 20, 100, elementalModifier: ElementalType.Fire, skillType: SkillType.AreaSkillAutomaticHits);
        this.AddAreaSkillSettings(SkillNumber.FlameStrike, true, 5f, 2f, 4f);
        this.CreateSkill(SkillNumber.GiganticStorm, "Gigantic Storm", ClassConsts.ALL_MGS, DamageType.Wizardry, 110, 6, 10, 120, 220, 118, elementalModifier: ElementalType.Wind, skillType: SkillType.AreaSkillAutomaticHits);
        this.CreateSkill(SkillNumber.ChaoticDiseier, "Chaotic Diseier", ClassConsts.ALL_DLS, DamageType.Physical, 190, 6, 15, 50, 100, 16, skillType: SkillType.AreaSkillAutomaticHits);
        this.AddAreaSkillSettings(SkillNumber.ChaoticDiseier, true, 1.5f, 1.5f, 6f);
        this.CreateSkill(SkillNumber.DoppelgangerSelfExplosion, "Doppelganger Self Explosion", ClassConsts.ALL_MGS, DamageType.Wizardry, 140, 3, 25, 20, 100, elementalModifier: ElementalType.Fire);
        this.CreateSkill(SkillNumber.KillingBlow, "Killing Blow", ClassConsts.ALL_FIGHTERS, DamageType.Physical, distance: 2, manaConsumption: 9, elementalModifier: ElementalType.Earth);
        this.CreateSkill(SkillNumber.BeastUppercut, "Beast Uppercut", ClassConsts.ALL_FIGHTERS, DamageType.Physical, distance: 2, manaConsumption: 9, elementalModifier: ElementalType.Fire);
        this.CreateSkill(SkillNumber.ChainDrive, "Chain Drive", ClassConsts.ALL_FIGHTERS, DamageType.Physical, distance: 4, abilityConsumption: 20, manaConsumption: 15, levelRequirement: 150, elementalModifier: ElementalType.Ice);
        this.CreateSkill(SkillNumber.DarkSide, "Dark Side", ClassConsts.ALL_FIGHTERS, DamageType.Physical, distance: 4, manaConsumption: 70, levelRequirement: 180, elementalModifier: ElementalType.Wind);
        this.CreateSkill(SkillNumber.DragonRoar, "Dragon Roar", ClassConsts.ALL_FIGHTERS, DamageType.Physical, distance: 3, abilityConsumption: 30, manaConsumption: 50, levelRequirement: 150, elementalModifier: ElementalType.Earth, skillType: SkillType.AreaSkillAutomaticHits);
        this.CreateSkill(SkillNumber.DragonSlasher, "Dragon Slasher", ClassConsts.ALL_FIGHTERS, DamageType.Physical, distance: 4, abilityConsumption: 100, manaConsumption: 100, levelRequirement: 200, elementalModifier: ElementalType.Wind);
        this.CreateSkill(SkillNumber.IgnoreDefense, "Ignore Defense", ClassConsts.ALL_FIGHTERS, DamageType.Physical, distance: 3, abilityConsumption: 10, manaConsumption: 50, levelRequirement: 120, energyRequirement: 404, skillType: SkillType.Buff, skillTarget: SkillTarget.ImplicitPlayer);
        this.CreateSkill(SkillNumber.IncreaseHealth, "Increase Health", ClassConsts.ALL_FIGHTERS, DamageType.Physical, distance: 7, abilityConsumption: 10, manaConsumption: 50, levelRequirement: 80, energyRequirement: 132, skillType: SkillType.Buff, skillTarget: SkillTarget.ImplicitParty);
        this.CreateSkill(SkillNumber.IncreaseBlock, "Increase Block", ClassConsts.ALL_FIGHTERS, DamageType.Physical, distance: 7, abilityConsumption: 10, manaConsumption: 50, levelRequirement: 50, energyRequirement: 80, skillType: SkillType.Buff, skillTarget: SkillTarget.ImplicitParty);
        this.CreateSkill(SkillNumber.Charge, "Charge", ClassConsts.ALL_FIGHTERS, DamageType.Physical, 90, 4, 15, 20);
        this.CreateSkill(SkillNumber.PhoenixShot, "Phoenix Shot", ClassConsts.ALL_FIGHTERS, DamageType.Physical, distance: 4, manaConsumption: 30, elementalModifier: ElementalType.Earth, skillType: SkillType.AreaSkillExplicitTarget);
