...
/// </summary>
public readonly ref struct MuunMountRequestRef
{
    private readonly Span<byte> _data;

    /// <summary>
    /// Initializes a new instance of the <see cref="MuunMountRequestRef"/> struct.
    /// </summary>
    /// <param name="data">The underlying data.</param>
    public MuunMountRequestRef(Span<byte> data)
        : this(data, true)
    {
    }
    ...
    /// <param name="data">The underlying data.</param>
    /// <param name="initialize">If set to <c>true</c>, the header data is automatically initialized and written to the underlying span.</param>
    private MuunMountRequestRef(Span<byte> data, bool initialize)
    {
        this._data = data;
        if (initialize)
        {
    ...
    /// <summary>
    /// Performs an implicit conversion from a Span of bytes to a <see cref="MuunMountRequest"/>.
    /// </summary>
    /// <param name="packet">The packet as span.</param>
    /// <returns>The packet as struct.</returns>
    public static implicit operator MuunMountRequestRef(Span<byte> packet) => new (packet, false);

    /// <summary>
    /// Performs an implicit conversion from <see cref="MuunMountRequest"/> to a Span of bytes.
    /// </summary>
    /// <param name="packet">The packet as struct.</param>
    /// <returns>The packet as byte span.</returns>
    public static implicit operator Span<byte>(MuunMountRequestRef packet) => packet._data; 
}
...
/// Causes reaction on server side: 
/// </summary>
public readonly ref struct ItemMoveRequestS21Ref
{
    private readonly Span<byte> _data;

    /// <summary>
    /// Initializes a new instance of the <see cref="ItemMoveRequestS21Ref"/> struct.
    /// </summary>
    /// <param name="data">The underlying data.</param>
    public ItemMoveRequestS21Ref(Span<byte> data)
        : this(data, true)
    {
    }
    ...
    /// <param name="data">The underlying data.</param>
    /// <param name="initialize">If set to <c>true</c>, the header data is automatically initialized and written to the underlying span.</param>
    private ItemMoveRequestS21Ref(Span<byte> data, bool initialize)
    {
        this._data = data;
        if (initialize)
        {
    ...
    public ItemStorageKind ToStorage
    {
        get => (ItemStorageKind)this._data[21];
        set => this._data[21] = (byte)value;
    }
    ...
    /// <summary>
    /// Performs an implicit conversion from a Span of bytes to a <see cref="ItemMoveRequestS21"/>.
    /// </summary>
    /// <param name="packet">The packet as span.</param>
    /// <returns>The packet as struct.</returns>
    public static implicit operator ItemMoveRequestS21Ref(Span<byte> packet) => new (packet, false);

    /// <summary>
    /// Performs an implicit conversion from <see cref="ItemMoveRequestS21"/> to a Span of bytes.
    /// </summary>
    /// <param name="packet">The packet as struct.</param>
    /// <returns>The packet as byte span.</returns>
    public static implicit operator Span<byte>(ItemMoveRequestS21Ref packet) => packet._data; 
}
...
/// Causes reaction on server side: The server checks if the player is allowed to create the character and sends a response back.
/// </summary>
public readonly ref struct CreateCharacterS21Ref
{
    private readonly Span<byte> _data;

    /// <summary>
    /// Initializes a new instance of the <see cref="CreateCharacterS21Ref"/> struct.
    /// </summary>
    /// <param name="data">The underlying data.</param>
    public CreateCharacterS21Ref(Span<byte> data)
        : this(data, true)
    {
    }
    ...
    /// <param name="data">The underlying data.</param>
    /// <param name="initialize">If set to <c>true</c>, the header data is automatically initialized and written to the underlying span.</param>
    private CreateCharacterS21Ref(Span<byte> data, bool initialize)
    {
        this._data = data;
        if (initialize)
        {
    ...
    /// <summary>
    /// Performs an implicit conversion from a Span of bytes to a <see cref="CreateCharacterS21"/>.
    /// </summary>
    /// <param name="packet">The packet as span.</param>
    /// <returns>The packet as struct.</returns>
    public static implicit operator CreateCharacterS21Ref(Span<byte> packet) => new (packet, false);

    /// <summary>
    /// Performs an implicit conversion from <see cref="CreateCharacterS21"/> to a Span of bytes.
    /// </summary>
    /// <param name="packet">The packet as struct.</param>
    /// <returns>The packet as byte span.</returns>
    public static implicit operator Span<byte>(CreateCharacterS21Ref packet) => packet._data; 
}
...
/// Causes reaction on server side: Damage is calculated and the target is hit, if the attack was successful. A response is sent back with the caused damage, and all surrounding players get an animation message.
/// </summary>
public readonly ref struct TargetedSkillS21Ref
{
    private readonly Span<byte> _data;

    /// <summary>
    /// Initializes a new instance of the <see cref="TargetedSkillS21Ref"/> struct.
    /// </summary>
    /// <param name="data">The underlying data.</param>
    public TargetedSkillS21Ref(Span<byte> data)
        : this(data, true)
    {
    }
    ...
    /// <param name="data">The underlying data.</param>
    /// <param name="initialize">If set to <c>true</c>, the header data is automatically initialized and written to the underlying span.</param>
    private TargetedSkillS21Ref(Span<byte> data, bool initialize)
    {
        this._data = data;
        if (initialize)
        {
    ...
    /// <summary>
    /// Performs an implicit conversion from a Span of bytes to a <see cref="TargetedSkillS21"/>.
    /// </summary>
    /// <param name="packet">The packet as span.</param>
    /// <returns>The packet as struct.</returns>
    public static implicit operator TargetedSkillS21Ref(Span<byte> packet) => new (packet, false);

    /// <summary>
    /// Performs an implicit conversion from <see cref="TargetedSkillS21"/> to a Span of bytes.
    /// </summary>
    /// <param name="packet">The packet as struct.</param>
    /// <returns>The packet as byte span.</returns>
    public static implicit operator Span<byte>(TargetedSkillS21Ref packet) => packet._data; 
}
...
/// Causes reaction on server side: It's forwarded to all surrounding players, so that the animation is visible. In the original server implementation, no damage is done yet for attack skills - there are separate hit packets.
/// </summary>
public readonly ref struct AreaSkillS21Ref
{
    private readonly Span<byte> _data;

    /// <summary>
    /// Initializes a new instance of the <see cref="AreaSkillS21Ref"/> struct.
    /// </summary>
    /// <param name="data">The underlying data.</param>
    public AreaSkillS21Ref(Span<byte> data)
        : this(data, true)
    {
    }
    ...
    /// <param name="data">The underlying data.</param>
    /// <param name="initialize">If set to <c>true</c>, the header data is automatically initialized and written to the underlying span.</param>
    private AreaSkillS21Ref(Span<byte> data, bool initialize)
    {
        this._data = data;
        if (initialize)
        {
    ...
    public uint TargetX
    {
        get => ReadUInt32LittleEndian(this._data[3..]);
        set => WriteUInt32LittleEndian(this._data[3..], value);
    }
    ...
    public ushort SkillId
    {
        get => (ushort)(this._data[7] << 8 | this._data[12] & 0xFF);
        set
        {
              this._data[7] = (byte)(value >> 8);
    ...
    public ushort ExtraTargetId
    {
        get => (ushort)(this._data[14] << 8 | this._data[16] & 0xFF);
        set
        {
              this._data[14] = (byte)(value >> 8);
              this._data[16] = (byte)(value & 0xFF);
        }
    }
    ...
    /// <summary>
    /// Performs an implicit conversion from a Span of bytes to a <see cref="AreaSkillS21"/>.
    /// </summary>
    /// <param name="packet">The packet as span.</param>
    /// <returns>The packet as struct.</returns>
    public static implicit operator AreaSkillS21Ref(Span<byte> packet) => new (packet, false);

    /// <summary>
    /// Performs an implicit conversion from <see cref="AreaSkillS21"/> to a Span of bytes.
    /// </summary>
    /// <param name="packet">The packet as struct.</param>
    /// <returns>The packet as byte span.</returns>
    public static implicit operator Span<byte>(AreaSkillS21Ref packet) => packet._data; 
}
...
/// </summary>
public readonly ref struct InventoryItemUseRef
{
    private readonly Span<byte> _data;

    /// <summary>
    /// Initializes a new instance of the <see cref="InventoryItemUseRef"/> struct.
    /// </summary>
    /// <param name="data">The underlying data.</param>
    public InventoryItemUseRef(Span<byte> data)
        : this(data, true)
    {
    }
    ...
    /// <param name="data">The underlying data.</param>
    /// <param name="initialize">If set to <c>true</c>, the header data is automatically initialized and written to the underlying span.</param>
    private InventoryItemUseRef(Span<byte> data, bool initialize)
    {
        this._data = data;
        if (initialize)
        {
    ...
    /// <summary>
    /// Performs an implicit conversion from a Span of bytes to a <see cref="InventoryItemUse"/>.
    /// </summary>
    /// <param name="packet">The packet as span.</param>
    /// <returns>The packet as struct.</returns>
    public static implicit operator InventoryItemUseRef(Span<byte> packet) => new (packet, false);

    /// <summary>
    /// Performs an implicit conversion from <see cref="InventoryItemUse"/> to a Span of bytes.
    /// </summary>
    /// <param name="packet">The packet as struct.</param>
    /// <returns>The packet as byte span.</returns>
    public static implicit operator Span<byte>(InventoryItemUseRef packet) => packet._data; 
}
...
/// Causes reaction on server side: The server should save supplied MU Helper data.
/// </summary>
public readonly ref struct MuHelperSaveDataRequestS21Ref
{
    private readonly Span<byte> _data;

    /// <summary>
    /// Initializes a new instance of the <see cref="MuHelperSaveDataRequestS21Ref"/> struct.
    /// </summary>
    /// <param name="data">The underlying data.</param>
    public MuHelperSaveDataRequestS21Ref(Span<byte> data)
        : this(data, true)
    {
    }
    ...
    /// <param name="data">The underlying data.</param>
    /// <param name="initialize">If set to <c>true</c>, the header data is automatically initialized and written to the underlying span.</param>
    private MuHelperSaveDataRequestS21Ref(Span<byte> data, bool initialize)
    {
        this._data = data;
        if (initialize)
        {
    ...
    public Span<byte> HelperData
    {
        get => this._data.Slice(5, 512);
    }

    /// <summary>
    /// Performs an implicit conversion from a Span of bytes to a <see cref="MuHelperSaveDataRequestS21"/>.
    /// </summary>
    /// <param name="packet">The packet as span.</param>
    /// <returns>The packet as struct.</returns>
    public static implicit operator MuHelperSaveDataRequestS21Ref(Span<byte> packet) => new (packet, false);

    /// <summary>
    /// Performs an implicit conversion from <see cref="MuHelperSaveDataRequestS21"/> to a Span of bytes.
    /// </summary>
    /// <param name="packet">The packet as struct.</param>
    /// <returns>The packet as byte span.</returns>
    public static implicit operator Span<byte>(MuHelperSaveDataRequestS21Ref packet) => packet._data; 
}
...
/// </summary>
public readonly ref struct MajesticSkillTreeAddRequestRef
{
    private readonly Span<byte> _data;

    /// <summary>
    /// Initializes a new instance of the <see cref="MajesticSkillTreeAddRequestRef"/> struct.
    /// </summary>
    /// <param name="data">The underlying data.</param>
    public MajesticSkillTreeAddRequestRef(Span<byte> data)
        : this(data, true)
    {
    }
    ...
    /// <param name="data">The underlying data.</param>
    /// <param name="initialize">If set to <c>true</c>, the header data is automatically initialized and written to the underlying span.</param>
    private MajesticSkillTreeAddRequestRef(Span<byte> data, bool initialize)
    {
        this._data = data;
        if (initialize)
        {
    ...
    /// <summary>
    /// Performs an implicit conversion from a Span of bytes to a <see cref="MajesticSkillTreeAddRequest"/>.
    /// </summary>
    /// <param name="packet">The packet as span.</param>
    /// <returns>The packet as struct.</returns>
    public static implicit operator MajesticSkillTreeAddRequestRef(Span<byte> packet) => new (packet, false);

    /// <summary>
    /// Performs an implicit conversion from <see cref="MajesticSkillTreeAddRequest"/> to a Span of bytes.
    /// </summary>
    /// <param name="packet">The packet as struct.</param>
    /// <returns>The packet as byte span.</returns>
    public static implicit operator Span<byte>(MajesticSkillTreeAddRequestRef packet) => packet._data; 
}
