...
/// </summary>
public readonly struct MuunMountRequest
{
    private readonly Memory<byte> _data;

    /// <summary>
    /// Initializes a new instance of the <see cref="MuunMountRequest"/> struct.
    /// </summary>
    /// <param name="data">The underlying data.</param>
    public MuunMountRequest(Memory<byte> data)
        : this(data, true)
    {
    }
    ...
    /// <param name="data">The underlying data.</param>
    /// <param name="initialize">If set to <c>true</c>, the header data is automatically initialized and written to the underlying span.</param>
    private MuunMountRequest(Memory<byte> data, bool initialize)
    {
        this._data = data;
        if (initialize)
        {
    ...
    /// <summary>
    /// Performs an implicit conversion from a Memory of bytes to a <see cref="MuunMountRequest"/>.
    /// </summary>
    /// <param name="packet">The packet as span.</param>
    /// <returns>The packet as struct.</returns>
    public static implicit operator MuunMountRequest(Memory<byte> packet) => new (packet, false);

    /// <summary>
    /// Performs an implicit conversion from <see cref="MuunMountRequest"/> to a Memory of bytes.
    /// </summary>
    /// <param name="packet">The packet as struct.</param>
    /// <returns>The packet as byte span.</returns>
    public static implicit operator Memory<byte>(MuunMountRequest packet) => packet._data; 
}
...
/// Causes reaction on server side: The server checks if the player is allowed to create the character and sends a response back.
/// </summary>
public readonly struct CreateCharacterS21
{
    private readonly Memory<byte> _data;

    /// <summary>
    /// Initializes a new instance of the <see cref="CreateCharacterS21"/> struct.
    /// </summary>
    /// <param name="data">The underlying data.</param>
    public CreateCharacterS21(Memory<byte> data)
        : this(data, true)
    {
    }
    ...
    /// <param name="data">The underlying data.</param>
    /// <param name="initialize">If set to <c>true</c>, the header data is automatically initialized and written to the underlying span.</param>
    private CreateCharacterS21(Memory<byte> data, bool initialize)
    {
        this._data = data;
        if (initialize)
        {
    ...
    /// <summary>
    /// Performs an implicit conversion from a Memory of bytes to a <see cref="CreateCharacterS21"/>.
    /// </summary>
    /// <param name="packet">The packet as span.</param>
    /// <returns>The packet as struct.</returns>
    public static implicit operator CreateCharacterS21(Memory<byte> packet) => new (packet, false);

    /// <summary>
    /// Performs an implicit conversion from <see cref="CreateCharacterS21"/> to a Memory of bytes.
    /// </summary>
    /// <param name="packet">The packet as struct.</param>
    /// <returns>The packet as byte span.</returns>
    public static implicit operator Memory<byte>(CreateCharacterS21 packet) => packet._data; 
}
...
/// Causes reaction on server side: Damage is calculated and the target is hit, if the attack was successful. A response is sent back with the caused damage, and all surrounding players get an animation message.
/// </summary>
public readonly struct TargetedSkillS21
{
    private readonly Memory<byte> _data;

    /// <summary>
    /// Initializes a new instance of the <see cref="TargetedSkillS21"/> struct.
    /// </summary>
    /// <param name="data">The underlying data.</param>
    public TargetedSkillS21(Memory<byte> data)
        : this(data, true)
    {
    }
    ...
    /// <param name="data">The underlying data.</param>
    /// <param name="initialize">If set to <c>true</c>, the header data is automatically initialized and written to the underlying span.</param>
    private TargetedSkillS21(Memory<byte> data, bool initialize)
    {
        this._data = data;
        if (initialize)
        {
    ...
    /// <summary>
    /// Performs an implicit conversion from a Memory of bytes to a <see cref="TargetedSkillS21"/>.
    /// </summary>
    /// <param name="packet">The packet as span.</param>
    /// <returns>The packet as struct.</returns>
    public static implicit operator TargetedSkillS21(Memory<byte> packet) => new (packet, false);

    /// <summary>
    /// Performs an implicit conversion from <see cref="TargetedSkillS21"/> to a Memory of bytes.
    /// </summary>
    /// <param name="packet">The packet as struct.</param>
    /// <returns>The packet as byte span.</returns>
    public static implicit operator Memory<byte>(TargetedSkillS21 packet) => packet._data; 
}
...
/// Causes reaction on server side: It's forwarded to all surrounding players, so that the animation is visible. In the original server implementation, no damage is done yet for attack skills - there are separate hit packets.
/// </summary>
public readonly struct AreaSkillS21
{
    private readonly Memory<byte> _data;

    /// <summary>
    /// Initializes a new instance of the <see cref="AreaSkillS21"/> struct.
    /// </summary>
    /// <param name="data">The underlying data.</param>
    public AreaSkillS21(Memory<byte> data)
        : this(data, true)
    {
    }
    ...
    /// <param name="data">The underlying data.</param>
    /// <param name="initialize">If set to <c>true</c>, the header data is automatically initialized and written to the underlying span.</param>
    private AreaSkillS21(Memory<byte> data, bool initialize)
    {
        this._data = data;
        if (initialize)
        {
    ...
    public ushort SkillId
    {
        get => (ushort)(this._data.Span[7] << 8 | this._data.Span[12] & 0xFF);
        set
        {
              this._data.Span[7] = (byte)(value >> 8);
              this._data.Span[12] = (byte)(value & 0xFF);
        }
    }
    ...
    public ushort ExtraTargetId
    {
        get => (ushort)(this._data.Span[14] << 8 | this._data.Span[16] & 0xFF);
        set
        {
              this._data.Span[14] = (byte)(value >> 8);
              this._data.Span[16] = (byte)(value & 0xFF);
        }
    }
    ...
    /// <summary>
    /// Performs an implicit conversion from a Memory of bytes to a <see cref="AreaSkillS21"/>.
    /// </summary>
    /// <param name="packet">The packet as span.</param>
    /// <returns>The packet as struct.</returns>
    public static implicit operator AreaSkillS21(Memory<byte> packet) => new (packet, false);

    /// <summary>
    /// Performs an implicit conversion from <see cref="AreaSkillS21"/> to a Memory of bytes.
    /// </summary>
    /// <param name="packet">The packet as struct.</param>
    /// <returns>The packet as byte span.</returns>
    public static implicit operator Memory<byte>(AreaSkillS21 packet) => packet._data; 
}
...
/// Causes reaction on server side: The server should save supplied MU Helper data.
/// </summary>
public readonly struct MuHelperSaveDataRequestS21
{
    private readonly Memory<byte> _data;

    /// <summary>
    /// Initializes a new instance of the <see cref="MuHelperSaveDataRequestS21"/> struct.
    /// </summary>
    /// <param name="data">The underlying data.</param>
    public MuHelperSaveDataRequestS21(Memory<byte> data)
        : this(data, true)
    {
    }
    ...
    /// <param name="data">The underlying data.</param>
    /// <param name="initialize">If set to <c>true</c>, the header data is automatically initialized and written to the underlying span.</param>
    private MuHelperSaveDataRequestS21(Memory<byte> data, bool initialize)
    {
        this._data = data;
        if (initialize)
        {
    ...
    /// <summary>
    /// Performs an implicit conversion from a Memory of bytes to a <see cref="MuHelperSaveDataRequestS21"/>.
    /// </summary>
    /// <param name="packet">The packet as span.</param>
    /// <returns>The packet as struct.</returns>
    public static implicit operator MuHelperSaveDataRequestS21(Memory<byte> packet) => new (packet, false);

    /// <summary>
    /// Performs an implicit conversion from <see cref="MuHelperSaveDataRequestS21"/> to a Memory of bytes.
    /// </summary>
    /// <param name="packet">The packet as struct.</param>
    /// <returns>The packet as byte span.</returns>
    public static implicit operator Memory<byte>(MuHelperSaveDataRequestS21 packet) => packet._data; 
}
...
/// </summary>
public readonly struct MajesticSkillTreeAddRequest
{
    private readonly Memory<byte> _data;

    /// <summary>
    /// Initializes a new instance of the <see cref="MajesticSkillTreeAddRequest"/> struct.
    /// </summary>
    /// <param name="data">The underlying data.</param>
    public MajesticSkillTreeAddRequest(Memory<byte> data)
        : this(data, true)
    {
    }
    ...
    /// <param name="data">The underlying data.</param>
    /// <param name="initialize">If set to <c>true</c>, the header data is automatically initialized and written to the underlying span.</param>
    private MajesticSkillTreeAddRequest(Memory<byte> data, bool initialize)
    {
        this._data = data;
        if (initialize)
        {
    ...
    /// <summary>
    /// Performs an implicit conversion from a Memory of bytes to a <see cref="MajesticSkillTreeAddRequest"/>.
    /// </summary>
    /// <param name="packet">The packet as span.</param>
    /// <returns>The packet as struct.</returns>
    public static implicit operator MajesticSkillTreeAddRequest(Memory<byte> packet) => new (packet, false);

    /// <summary>
    /// Performs an implicit conversion from <see cref="MajesticSkillTreeAddRequest"/> to a Memory of bytes.
    /// </summary>
    /// <param name="packet">The packet as struct.</param>
    /// <returns>The packet as byte span.</returns>
    public static implicit operator Memory<byte>(MajesticSkillTreeAddRequest packet) => packet._data; 
}
    /// <summary>
